  ...
  <div class="nav">
    <ul class="main-menu">
      ...
      <div>
       ...
       <button id="subject" value="subject" onclick="search()">Subject List</button>
       <script type="text/javascript">
          function search() {
          var stdentId = document.getElementById("id").innerHTML;

          var xhttp = new XMLHttpRequest();
          xhttp.open("POST", "subjectAction.php", true);

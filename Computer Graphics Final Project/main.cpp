...
int waterMoveCount = 0;
//char text[] = "Press F7 for INSTRUCTION #";
//char textRed[] = "KEY_UP : AIUB color change to RED";
//char textBlue[] = "KEY_DOWN : AIUB color change to BLUE";
//char textBack[] = "KEY_RIGHT : Back to AIUB campus view";
//char screenReshape[] = "KEY_LEFT : Resize the screen ( small -> Full-screen & Full-screen -> small )";
//char t[] = "End";
int h = 0;
...
void keyboard_for_logo_color_change(int key, int a, int b)
{
    ...
    switch (key)
    {
        ...
        case GLUT_KEY_LEFT: //toggle screenmode
            if (!fullscreen)
            {
                glutFullScreen();
                fullscreen = true;
...
/*
        ...
        glPushMatrix();
        glTranslatef(water1,0,0);
        glPushMatrix();
        glTranslatef(3.9,-1.45,0);
        glColor3ub(0,0,103);
        glBegin(GL_POLYGON);
        glVertex3f(-.2,0,0);
        glVertex3f(.2,-.5,0);
        ...
        ///WATER-1
        glPushMatrix();
        glTranslatef(water2,0,0);
        glPushMatrix();
        glTranslatef(3.3,-.95,0);
        glColor3ub(0,0,103);
        glBegin(GL_POLYGON);
        glVertex3f(-.2,0,0);
        glVertex3f(.2,-.5,0);
...
void display()
{
    ...
    if (h == 1)
    {
        ...
        ///Instruction Text
        glPushMatrix();
//       Sprint(-1.5, 2, textRed);
//        Sprint(-1.5, 1.7, textBlue);
 //       Sprint(-1.5, 1.4, textBack);
     //   Sprint(-1.5, 1.1, screenReshape);
        glPopMatrix();
...
int main(int argc, char** argv)
{
    ...
    // glutFullScreen();
    //sndPlaySound("soundHeli2.wav",SND_ASYNC|SND_LOOP);
    ...
    glutTimerFunc(500, waterMove, 0); //Add a timer
    glutTimerFunc(100, update1, 0);
    glutTimerFunc(100, update2, 0);
    glutTimerFunc(100, update5, 0);
